...
public:
    ...
    // nextToken public rakha gaya hai taake GoogleTest mein use ho sake.
    Token nextToken(){
...
// --- Main Execution (Reduced to one test) ---
...
int main(){
    ...
    run_test("FINAL End-to-End Program (Expected: 11, 16)", valid_code);
    return 0;
}